...
options initialize_options(int argc, char* argv[])
{
	...
	opt_desc.add_options()
		...
		("min", opt::value<int>(&result.arr_min_num)->default_value(0), "minimum value of numbers in array")
		("max", opt::value<int>(&result.arr_max_num)->default_value(100), "maximum value of numbers in array")
		...
		("output,o", opt::value<string>(&result.output)->default_value("hs"), "hs - human readable sparse, hv - human readable verbose, m - output only benchmark times in nanoseconds")
